 ...
 if(isset($_POST['updation'])){
    ...
    $id = $_GET['id'];
     ...
     $password = $_POST['password'];
        ...
        $query = " UPDATE student set id=$id , rollno='$rollno', fname='$fname', lname='$lname', faname='$faname', gender='$gender', dept='$dept', email='$email', password='$password' where id=$id";
...
<br>
                   <input type="text" name="rollno" id="" class = "form-control" placeholder = "Student ID (eg. 01, 73, 116)" required value = "<?php echo $arrdata['rollno']; ?>"> <br>
